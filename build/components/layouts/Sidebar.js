        ...
        return (React.createElement(Layout.Sider, { collapsible: true, collapsed: this.state.collapsed, onCollapse: this.toggle },
            ...
            React.createElement(Menu, { theme: "dark", mode: this.state.mode, defaultSelectedKeys: ["1"] },
                React.createElement(Menu.Item, { key: "1" },
                    React.createElement(Link, { to: "/fillLayout" },
                        React.createElement(Icon, { type: "file" }),
                        React.createElement("span", { className: "nav-text" }, "Fill Layout"))),
                React.createElement(Menu.Item, { key: "2" },
                    React.createElement(Link, { to: "/rowLayout" },
                        React.createElement(Icon, { type: "file" }),
                        React.createElement("span", { className: "nav-text" }, "Row Layout"))),
                React.createElement(Menu.Item, { key: "3" },
                    React.createElement(Link, { to: "/formLayout" },
                        React.createElement(Icon, { type: "file" }),
                        React.createElement("span", { className: "nav-text" }, "Form Layout"))),
                React.createElement(Menu.Item, { key: "4" },
                    React.createElement(Link, { to: "/gridLayout" },
                        React.createElement(Icon, { type: "file" }),
                        React.createElement("span", { className: "nav-text" }, "Grid Layout")))),
